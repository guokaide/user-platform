...
//        System.out.println(entityManager.find(User.class, user.getId()));
    ...
    private void registerMBean() {
        ...
        try {
            mBeanServer.registerMBean(new UserManager(new User()), new ObjectName("org.geektimes.projects.user.management.UserManager:type=UserManager"));
        } catch (Exception e) {
            logger.warning("Register MBean failed!");
        }
