...
public class DatabaseUserRepository implements UserRepository {
    ...
    public DatabaseUserRepository() {
        ...
        String databaseURL = "jdbc:derby:/Users/kai/programs/github/work/geekbang-lessons/projects/stage-0/user-platform/db/user-platform;create=true";
        try {
            Connection connection = DriverManager.getConnection(databaseURL);
            dbConnectionManager.setConnection(connection);
        } catch (SQLException e) {
            logger.warning("create connection with db failed");
        }
    }
...
//        ResultSet resultSet = executeQuery(INSERT_USER_DML_SQL, x -> x, x -> logger.warning("execute failed"),
//                user.getName(), user.getPassword(), user.getEmail(), user.getPhoneNumber());
        ...
        try {
            ...
            logger.warning("save user failed");
            return false;
        }
        return true;
    }
